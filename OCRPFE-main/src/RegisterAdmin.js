...
const RegisterAdmin = () => {
    ...
    const handlesubmit = (e) => {
            ...
            if (IsValidate()) {
            //console.log(regobj);
            fetch("https://ocrpsbe.azurewebsites.net/api/Authenticate/register-admin", {
                method: "POST",
        ...
        <div  className="login-container" style={{color:'black',justifyContent:'center'}} >
            <div  style={{ margin: '100px 100px 110px 100px'  }}>
                <form className="container" onSubmit={handlesubmit}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <div  style={{justifyContent:'center', display:'flex',flexWrap:'wrap', width:'300px',position:'relative',textAlign:'center',marginLeft:'450px'}}>
                        <div>
